...
import favoriteRecipesMockData from './mocks/favoriteRecipesMockData';
import { createLocalStorage, setLocalStorage } from '../helpers/localStorage';

beforeEach(() => {
  createLocalStorage('favoriteRecipes');
  setLocalStorage('favoriteRecipes', favoriteRecipesMockData);
});
afterEach(() => {
...
describe('Testa o componente Recipes', () => {
  it('Testa se a página de DoneRecipes renderiza corretamente', async () => {
    renderWithRouterAndRedux(<App />, undefined, '/favorite-recipes');
